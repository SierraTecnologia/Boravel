    ...
    <div class="col-md-12 mt-4">
        ...
        {!! Form::model($order, ['route' => [config('cms.backend-route-prefix', 'cms').'.orders.update', $order->id], 'method' => 'patch']) !!}
            ...
            <div class="row raw-margin-bottom-24">
                <div class="col-md-6">
                    @include('siravel::orders.breadcrumbs', ['location' => ['edit']])
                </div>
                <div class="col-md-6">
        ...
        @if ($order->status !== 'cancelled' && !$order->hasRefundedOrderItems())
            {!! Form::open(['id' => 'cancelForm', 'url' => config('cms.backend-route-prefix', 'cms').'/orders/cancel', 'method' => 'post', 'class' => 'inline-form float-left']) !!}
