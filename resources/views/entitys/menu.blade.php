...
<li class="sidebar-header"><span><span class="fa fa-bank"></span> E-Boravel</span></li>

<li class="nav-item @if (Request::is(config('cms.backend-route-prefix', 'cms').'/siravel-analytics') || Request::is(config('cms.backend-route-prefix', 'cms').'/siravel-analytics/*')) active @endif">
    <a class="nav-link" href="{{ url(config('cms.backend-route-prefix', 'cms').'/siravel-analytics') }}"><span class="fa fa-fw fa-line-chart"></span> Analytics</a>
</li>
