...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('/vendor/boss/img/favicon.png') }}">

    <title>Boss</title>

    <!-- Style sheets-->
    <link href="https://fonts.googleapis.com/css?family=Nunito" rel="stylesheet">
    <link href="{{ asset(mix($cssFile, 'vendor/boss')) }}" rel="stylesheet" type="text/css">
</head>
<body>
<div id="boss" v-cloak>
    ...
    <div class="container mb-5">
        <div class="d-flex align-items-center py-4 header">
            ...
            <h4 class="mb-0 ml-2"><strong>Laravel</strong> Boss</h4>
...
<!-- Global Boss Object -->
<script>
    window.Boss = @json($bossScriptVariables);
</script>

<script src="{{asset(mix('app.js', 'vendor/boss'))}}"></script>
</body>
</html>
