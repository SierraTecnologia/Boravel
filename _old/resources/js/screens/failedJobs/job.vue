<script type="text/ecmascript-6">
    ...
    export default {
        ...
        mounted() {
            ...
            document.title = "Boss - Failed Jobs";
        ...
        methods: {
            loadFailedJob(id) {
                ...
                this.$http.get('/' + Boss.path + '/api/jobs/failed/' + id)
                    .then(response => {
             ...
             */
            reloadRetries() {
                this.$http.get('/' + Boss.path + '/api/jobs/failed/' + this.$route.params.jobId)
                    .then(response => {
            ...
            retry(id) {
                ...
                this.$http.post('/' + Boss.path + '/api/jobs/retry/' + id)
                    .then(() => {
                        setTimeout(() => {
                            this.reloadRetries();
        ...
        <div class="card mt-4" v-if="ready && job.retried_by.length">
            ...
            <table class="table table-hover table-sm mb-0">
                ...
                <tr v-for="retry in job.retried_by">
                    ...
                    <td class="table-fit">
                        <a v-if="retry.status == 'failed'" :href="'/' + Boss.path + '/failed/'+retry.id">
                            {{ retry.id }}
                        </a>
