<script type="text/ecmascript-6">
    ...
    export default {
         ...
         */
        mounted() {
            document.title = "Boss - Monitoring";
        ...
        methods: {
            ...
            loadTags() {
                ...
                this.$http.get('/' + Boss.path + '/api/monitoring')
                    .then(response => {
            ...
            monitorNewTag() {
                ...
                this.$http.post('/' + Boss.path + '/api/monitoring', {'tag': this.newTag})
                    .then(response => {
             ...
             */
            stopMonitoring(tag) {
                this.$http.delete('/' + Boss.path + '/api/monitoring/' + encodeURIComponent(tag))
                    .then(() => {
