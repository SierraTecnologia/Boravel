<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods: {
             ...
             */
            loadStats() {
                return this.$http.get('/' + Boss.path + '/api/stats')
                    .then(response => {
             ...
             */
            loadWorkers() {
                return this.$http.get('/' + Boss.path + '/api/masters')
                    .then(response => {
             ...
             */
            loadWorkload() {
                return this.$http.get('/' + Boss.path + '/api/workload')
                    .then(response => {
