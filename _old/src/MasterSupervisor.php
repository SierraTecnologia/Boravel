...
class MasterSupervisor implements Pausable, Restartable, Terminable
{
    ...
    public function __construct()
    {
        ...
        app(BossCommandQueue::class)->flush($this->commandQueue());
    }
    ...
    public function terminate($status = 0)
    {
        ...
        if (config('boss.fast_termination')) {
            app(CacheFactory::class)->forget('boss:terminate:wait');
        }
    ...
    {
        foreach (app(BossCommandQueue::class)->pending($this->commandQueue()) as $command) {
