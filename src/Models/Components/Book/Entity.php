<?php namespace Boravel\Models\Components\Book;

use Boravel\Actions\Book\Activity;
use Boravel\Actions\Book\Comment;
use Boravel\Actions\Book\Tag;
use Boravel\Actions\Book\View;
use Boravel\Models\Permissions\EntityPermission;
use Boravel\Models\Permissions\JointPermission;
use Boravel\Models\Ownable;
use Carbon\Carbon;
