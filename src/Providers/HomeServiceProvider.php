...
class HomeServiceProvider extends ServiceProvider
{
    ...
    protected function registerAppServices(): void
    {
        ...
        $this->app->bind(
            \Boravel\Services\Writelabel\Manifest\Contracts\Manifest::class,
            \Boravel\Services\Writelabel\Manifest\AppManifest::class
        );

        $this->app->bind(
            \Boravel\Services\Writelabel\SiteMap\Contracts\SiteMapBuilder::class,
            \Boravel\Services\Writelabel\SiteMap\AppSiteMapBuilder::class
        );

        $this->app->bind(
            \Boravel\Services\Writelabel\Rss\Contracts\RssBuilder::class,
            \Boravel\Services\Writelabel\Rss\AppRssBuilder::class
        );
