...
class SiteDestroyConversation extends Conversation
{
    ...
    {
        $this->ask($this->getQuestion(trans('boravel.sites.delete_confirm_1')), function (Answer $answer) {
    ...
    {
        $this->ask($this->getQuestion(trans('boravel.sites.delete_confirm_2')), function (Answer $answer) {
