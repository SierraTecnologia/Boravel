...
use Boravel\Http\Requests\CreatePageRequest as CreateRequest;
use Boravel\Http\Requests\CreatePageRequest as UpdateRequest;
use Boravel\Page as Model;
...
class PageController extends ResourceController
{
    ...
    {
        view()->share('categories', \App\Models\Category::dropdown());
