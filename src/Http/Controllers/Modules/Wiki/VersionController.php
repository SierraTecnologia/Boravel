...
use Boravel\Models\Wiki\Page;
use Boravel\Models\Wiki\Version;
...
class VersionController extends Controller
{
	...
	public function index($pageId)
	{
		...
		// Load view
		return view('wiki.version.index', [
			'title' => _('Versions'),
			'subtitle' => $page,
	...
	protected function compareVersions(Version $before, Version $after)
	{
		...
		// Load view
		return view('wiki.version.compare', [
			'title' => _('Versions'),
			'subtitle' => _('Compare'),
			'before' => $before,
			'after' => $after,
