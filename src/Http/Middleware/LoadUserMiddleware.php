...
namespace Boravel\Http\Middleware;
...
use Boravel\Services\UserService;
...
class LoadUserMiddleware implements Received
{
    ...
    public function received(IncomingMessage $message, $next, BotMan $bot)
    {
        ...
        //     'email' => $botUser->getId() . '@boravelbot.com',
        //     'password' => Hash::make($botUser->getUsername() . '-boravelbot'),
        // ]);
     ...
     *
     * @throws \Boravel\Exceptions\PrivateConversationNotAllowedException
     ...
     * @param \BotMan\BotMan\BotMan $bot
     *
     * @throws \Boravel\Exceptions\InteractingWithBotException
     * @throws \BotMan\BotMan\Exceptions\Base\BotManException
     */
     ...
     * @param \BotMan\BotMan\BotMan $bot
     *
     * @throws \Boravel\Exceptions\MissingGroupException
     * @throws \BotMan\BotMan\Exceptions\Base\BotManException
     */
