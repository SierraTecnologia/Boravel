...
namespace Boravel\Notifications\Metrics;
...
class ModelChanged extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->view(
                'admin.tracking.larametrics::emails.model-changed', [
                'modelInfo' => $modelInfo,
            ...
            return (new SlackMessage)
                ...
                ->attachment(
                    function ($attachment) use ($modelInfo) {
                        ...
                        $attachment->title($modelInfo['model'] . ' #' . $modelInfo['original']['id'], route('admin.tracking.larametrics::models.show', $modelInfo['id']))
