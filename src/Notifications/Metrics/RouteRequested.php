...
class RouteRequested extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->view(
                'admin.tracking.larametrics::emails.route-requested', [
        ...
        return (new SlackMessage)
            ...
            ->attachment(
                function ($attachment) use ($requestInfo, $content) {
                    $attachment->title('Request #' . $requestInfo['id'], route('admin.tracking.larametrics::requests.show', $requestInfo['id']))
                        ->content($content)
                        ->fields(
                            [
