...
namespace Boravel\Console\Commands;

use Boravel\Drivers\TelegramDriver;
use Boravel\Models\Reminder;
use Boravel\Services\StationService;
...
class SendRemindersCommand extends Command
{
    ...
    /** @var \Boravel\Services\StationService  */
