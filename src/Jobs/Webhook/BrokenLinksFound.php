...
namespace Boravel\Jobs\Webhook;
...
class BrokenLinksFound implements ShouldQueue
{
    ...
    {
        $this->botman->say(
            trans('boravel.webhook.broken_links_found', ['url' => $this->payload->site->url]),
    ...
    {
        $this->botman->say(trans('boravel.brokenlinks.result', [
