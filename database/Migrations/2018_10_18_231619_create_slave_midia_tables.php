...
class CreateSlaveMidiaTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create(
            config('app.db-prefix', '').'files', function (Blueprint $table) {
                $table->increments('id');
                $table->string('name');
        ...
        Schema::create(
            config('app.db-prefix', '').'images', function (Blueprint $table) {
                $table->increments('id');
                $table->string('location');
        ...
        Schema::create(
            config('app.db-prefix', '').'imageables', function (Blueprint $table) {
                $table->increments('id');
        ...
        Schema::create(
            config('app.db-prefix', '').'photo_albums', function (Blueprint $table) {
                $table->engine = 'InnoDB';
        ...
        Schema::create(
            config('app.db-prefix', '').'photos', function (Blueprint $table) {
                $table->engine = 'InnoDB';
                $table->increments('id')->unsigned();
        ...
        Schema::create(
            config('app.db-prefix', '').'videos', function (Blueprint $table) {
                $table->engine = 'InnoDB';
                $table->increments('id')->unsigned();
                $table->string('name', 255)->nullable();
        ...
        Schema::create(
            config('app.db-prefix', '').'videoables', function (Blueprint $table) {
                $table->increments('id');
        ...
        Schema::create(
            config('app.db-prefix', '').'thumbnails', function (Blueprint $table) {
                $table->increments('id');
                $table->string('path')->default('');
                $table->string('relative_url')->default('');
        ...
        Schema::create(
            config('app.db-prefix', '').'thumbnailables', function (Blueprint $table) {
                $table->increments('id');
